// var cellElementOriginal: ParentNode | undefined | null;
...
//     let imgOriginal = this.cellElementOriginal.querySelector("img");
//     this.cellElementOriginal.removeChild(imgOriginal);
...
//     imageElement.ondragstart = this.drag(event);
